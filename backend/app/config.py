...
class Settings(BaseSettings):
    ...
    rag_top_k: int = 3
    # Tarata su un eval set di 14 Q&A: gli score in-dominio (0.855-0.896) e
    # fuori-dominio (≤0.840) lasciano un gap pulito attorno a 0.85, scelto per
    # zero falsi positivi. Unico caso fuori, per mismatch lessicale ("produttive"
    # vs "commerciale"): "attività commerciale" resta sotto soglia a 0.822.
